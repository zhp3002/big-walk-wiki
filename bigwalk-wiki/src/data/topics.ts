...
export const topics: Topic[] = [
  ...
  { slug: 'split-screen', code: 'MUL-03', name: 'Split Screen / Local Co-op', category: 'multiplayer',
    keywords: 'big walk split screen / big walk local coop / big walk ps5 split screen / big walk couch co op',
    tags: ['SPLIT SCREEN', 'LOCAL', 'NOT SUPPORTED'], hasMdx: true,
    summary: 'No — Big Walk has no split screen or couch co-op on any platform, per the official FAQ. Same-room workaround: two devices via crossplay.',
    pairsWith: ['max-players', 'crossplay'] },
